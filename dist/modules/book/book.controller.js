...
// ----------create-book---------
const createBook = (0, catchAsync_1.catchAsync)((req, res) =>
...
// ---------------getallbook------------
const getAllBooks = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.pick)(
      req.query,
      constance_1.bookFilterableFields,
    )
    const paginationOptions = (0, pick_1.pick)(
      req.query,
      paginationField_1.paginationFiled,
    )
...
// ----------------GetSingleBook------------
const getSingleBook = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
//----------------update Book------------------
const updateBook = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id
...
// ---------Delete a Book----------
const deleteBook = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id
